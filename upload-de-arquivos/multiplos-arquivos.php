...
<body>
    ...
    //função propria do php para manipular array de arquivos
    ...
    if(isset($_POST['enviar'])){
        ...
        foreach ($arquivoArray as $arquivo) {
            ...
            O arquivo <b> '.$arquivo['name'].' </b> excede o tamanho maximo permitido!
            </div>';
                ...
                if(in_array($extensao, $permitido)){//se a extensao do arquivo enviado for permitida
                    ...
                    $tmp = $arquivo['tmp_name'];//pegando o nome temporario do arquivo no servidor
                    ...
                    if(move_uploaded_file($tmp,$pasta.$novoNome)){//move_uploaded_file --> função para fazer o upload do arquivo com parametros: (<nome-temporario-do-arquivo>,<Local-para-fazer-upload>.<nome-que-o-arquivo-receberá-na-pasta>)
                        ...
                        echo "Não foi possivel fazer o upload do arquivo <b> ".$arquivo['name']." </b>. Tente novamente com outro arquivo";
                    }
                    
                }else{//exibir um alerta dizendo que o arquivo não é permitido. Causa --> extensao
                    echo '<div class="alert alert-danger" role="alert">
                    <b> '.$arquivo['name'].' </b>: Tipo de arquivo não suportado. Tente novamente com outro arquivo.
            </div>';
